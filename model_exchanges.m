%%%% ith entry of Mod is an index j such that particle ninds(i)'s model /
%%%% stats are replaced by 
...
%         inds_j=find(ismember(ninds,intersect(ninds(inds_j),neighbs{i}(2:end))));
