...
matlab -nodesktop -nodisplay -r "save_dr='${data_dr}'; data_dr='${data_dr}'; input_data='${input_data}'; homecell_dr='${SLURM_SCRATCH}/'; load(['${SLURM_SCRATCH}/','precomp_',input_data]); run parconsoldata.m;"
